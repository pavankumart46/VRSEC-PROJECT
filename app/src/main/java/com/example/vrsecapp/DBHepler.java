...
public class DBHepler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql = "create table UserName (id integer primary key, name,userId,pass);" +
                "create table Problems (id integer primary key, name,title,description,location);";
